...
This template, designed for creative designers, agencies, freelancers, photographers or anyone.
It is fully responsive and retina/hi-dpi ready making it pixel sharp on any devices. It has animating
stats section, working contact form, stylish portfolio section and other features you will only find
on premium html templates. Built with clean and organized code, this template is very easy to customize.
...
Icons:
 ...
 - Favicon made by (https://www.flaticon.com/authors/monkik) from ("www.flaticon.com")
